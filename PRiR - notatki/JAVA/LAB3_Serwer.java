...
public class LAB3_Serwer { //  tworzy gniazdo serwera i nasłuchuje połączeń przychodzących na porcie 80
                           
    public static void main(String[] args) throws IOException { ServerSocket server = new ServerSocket(80);
        try {
            while (true) {
                Socket socket = server.accept();
                new jHTTPSMulti(socket);  //tworzy nowy wątek klasy jHTTPSMulti, który odpowiada na żądanie klienta.
            } // while
        } // try
